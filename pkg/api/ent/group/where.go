...
func HasNamespaces() predicate.Group {
	return predicate.Group(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(NamespacesTable, FieldID),
			sqlgraph.Edge(sqlgraph.M2M, true, NamespacesTable, NamespacesPrimaryKey...),
		)
		sqlgraph.HasNeighbors(s, step)
	})
}
...
func HasNamespacesWith(preds ...predicate.Namespace) predicate.Group {
	return predicate.Group(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
