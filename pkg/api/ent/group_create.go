...
func (gc *GroupCreate) SetParentID(id int) *GroupCreate {
...
func (gc *GroupCreate) SetNillableParentID(id *int) *GroupCreate {
	if id != nil {
...
func (gc *GroupCreate) AddNamespaceIDs(ids ...int) *GroupCreate {
	gc.mutation.AddNamespaceIDs(ids...)
	return gc
}

// AddNamespaces adds the "namespaces" edges to the Namespace entity.
func (gc *GroupCreate) AddNamespaces(n ...*Namespace) *GroupCreate {
	ids := make([]int, len(n))
	for i := range n {
		ids[i] = n[i].ID
	}
	return gc.AddNamespaceIDs(ids...)
}
...
func (gc *GroupCreate) createSpec() (*Group, *sqlgraph.CreateSpec) {
	...
	if nodes := gc.mutation.NamespacesIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
