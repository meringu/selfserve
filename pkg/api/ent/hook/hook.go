...
type ModuleVersionFunc func(context.Context, *ent.ModuleVersionMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f ModuleVersionFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
