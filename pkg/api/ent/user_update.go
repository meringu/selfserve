...
func (uu *UserUpdate) AddNamespaceIDs(ids ...int) *UserUpdate {
...
func (uu *UserUpdate) ClearNamespaces() *UserUpdate {
	uu.mutation.ClearNamespaces()
	return uu
}

// RemoveNamespaceIDs removes the "namespaces" edge to Namespace entities by IDs.
func (uu *UserUpdate) RemoveNamespaceIDs(ids ...int) *UserUpdate {
...
func (uu *UserUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if uu.mutation.NamespacesCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
	...
	if nodes := uu.mutation.RemovedNamespacesIDs(); len(nodes) > 0 && !uu.mutation.NamespacesCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
			Table:   user.NamespacesTable,
...
// AddNamespaceIDs adds the "namespaces" edge to the Namespace entity by IDs.
func (uuo *UserUpdateOne) AddNamespaceIDs(ids ...int) *UserUpdateOne {
...
// ClearNamespaces clears all "namespaces" edges to the Namespace entity.
func (uuo *UserUpdateOne) ClearNamespaces() *UserUpdateOne {
	uuo.mutation.ClearNamespaces()
	return uuo
}

// RemoveNamespaceIDs removes the "namespaces" edge to Namespace entities by IDs.
func (uuo *UserUpdateOne) RemoveNamespaceIDs(ids ...int) *UserUpdateOne {
...
func (uuo *UserUpdateOne) sqlSave(ctx context.Context) (_node *User, err error) {
	...
	if uuo.mutation.NamespacesCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
			Table:   user.NamespacesTable,
	...
	if nodes := uuo.mutation.RemovedNamespacesIDs(); len(nodes) > 0 && !uuo.mutation.NamespacesCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
			Table:   user.NamespacesTable,
